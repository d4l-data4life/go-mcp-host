...
func main() {
	...
	// Create MCP manager with weather server
	...
	// Create OpenAI-compatible client (pointed at local Ollama)
	...
	aiAgent := agent.NewAgent(db, mcpManager, llmClient, agentConfig)
